    ...
    <div class="col-6 d-flex justify-content-end">
      <div class="d-flex gap-2 align-items-center">
          ...
          <NuxtLink
            ...
            :class="[isActivePage('/myprofile') ? 'text-primary' : 'text-secondary' ,'text-decoration-none rounded p-1']"
            >
            <div class="d-flex flex-row gap-2 align-items-center">
              <DefaultAvatar :name="me.data.value?.name" :surname="me.data.value?.surname"/>
            </div>
          </NuxtLink>
