...
import type { EmptySlot, Indexes, SlotInfo, MyScheduleGetResponse } from '../types';

export const timeToSlotIndex = (worktime: MyScheduleGetResponse['worktime'], time: string): number => {
...
export const slotIndexToDatetime = (
    worktime: MyScheduleGetResponse['worktime'],
    date: string,
    index: number
): Date => {
